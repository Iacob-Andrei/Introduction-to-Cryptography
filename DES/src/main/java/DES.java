class DES {
    ...
    String round(String input, String key, int num) {
        ...
        // start function
        // Expansion permutation 32 to 48
        temp = permutation(EP, temp);

        // xor temp and round key 48
        temp = xor(temp, key);

        // s-box table 48 to 32
        temp = sBox(temp);

        // permutation with P before final xor
        ...
        //System.out.println("L" + (num + 1)+ " = " + right.toUpperCase() + ", R"+ (num + 1) + " = "+ left.toUpperCase() + ", Key round = " + key.toUpperCase());
        return right + left;
    }
    ...
    String encrypt(String plainText, String key) {
        ...
        //System.out.println("Initial permutatian: " + plainText.toUpperCase());
